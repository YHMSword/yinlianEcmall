...
include_once "D:/phpStudy/WWW/gcxz54/includes/payments/yinlian/sdk/log.class.php";
include_once "D:/phpStudy/WWW/gcxz54/includes/payments/yinlian/sdk/SDKConfig.php";
include_once "D:/phpStudy/WWW/gcxz54/includes/payments/yinlian/sdk/common.php";
include_once "D:/phpStudy/WWW/gcxz54/includes/payments/yinlian/sdk/cert_util.php";
class AcpService {
	...
	static function signByCertInfo(&$params, $cert_path, $cert_pwd) {
		...
		if($params['signMethod']=='01') {
			...
			if($params['version']=='5.0.0'){
				...
				$re=openssl_sign($params_sha1x16,$signature,$private_key,OPENSSL_ALGO_SHA1);
